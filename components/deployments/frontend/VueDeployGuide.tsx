...
export default function VueDeployGuide() {
  const steps = [
    {
    ...
    {
      title: "Create a deploy Vue website",
      description: (
        <div>
    ...
    },
    {
      ...
      description: "Choose the Git repository that contains your Vue files. You have the option to choose GitHub or GitLab",
      image: (
        <Image
    ...
    },
    {
      ...
      description: (
        <div>
          <h1>Set the following settings for your Vue:</h1>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900 border-l-4 border-yellow-400 dark:border-yellow-600 p-4 my-4" role="alert">
            ...
            <h1>
              Cloudinator will deploy your Vue files
              <ul className="list-none ml-6 space-y-1">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-3">Make sure in your Vue project file setup <span className="font-bold">standalone</span> in config file</span>
                </li>
              </ul>
            </h1>
          </div>
