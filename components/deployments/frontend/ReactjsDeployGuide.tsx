...
export default function ReactjsDeployGuide() {
  const steps = [
    {
    ...
    {
      title: "Create a deploy React.js website",
      description: (
        <div>
    ...
    },
    {
      ...
      description: (
        <div>
          <h1>Set the following settings for your React.js:</h1>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900 border-l-4 border-yellow-400 dark:border-yellow-600 p-4 my-4" role="alert">
            ...
            <h1>
              Cloudinator will deploy your React.js files
              <ul className="list-none ml-6 space-y-1">
                ...
                <li className="flex items-start">
                  ...
                  <span className="ml-3">Make sure in your React.js project file setup <span className="font-bold">standalone</span> in config file</span>
                </li>
              </ul>
            </h1>
          </div>
  ...
  return (
    <div className="w-full bg-purple-50 dark:bg-gray-800 p-8">
      <h1 className="text-purple-700 dark:text-purple-300 text-4xl font-bold mb-8 text-center">
        How to Deploy React.js on Cloudinator
      </h1>
